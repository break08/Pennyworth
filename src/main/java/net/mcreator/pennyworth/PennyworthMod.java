package net.mcreator.pennyworth;
...
import net.mcreator.pennyworth.init.PennyworthModItems;
import net.mcreator.pennyworth.init.PennyworthModBlocks;
...
@Mod("pennyworth")
public class PennyworthMod {
	public static final Logger LOGGER = LogManager.getLogger(PennyworthMod.class);
	public static final String MODID = "pennyworth";

	public PennyworthMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		PennyworthModBlocks.REGISTRY.register(modEventBus);
		PennyworthModItems.REGISTRY.register(modEventBus);
		PennyworthModMobEffects.REGISTRY.register(modEventBus);
